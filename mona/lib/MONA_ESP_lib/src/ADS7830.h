...
Forked and Modified by Bart Garcia 
*/
/**************************************************************************/
...
**************************************************************************/
    #define ADS7830_CONVERSIONDELAY             (5) //value is in milli seconds
    //According to datasheet, time for a repeated start is a min of 4.7 microseconds
...
**************************************************************************/
    ...
    #define ADS7830_REG_COMMAND_CH_DIFF_7_6     (0x70)      //
    //According to table 2 in Datasheet
    #define ADS7830_REG_COMMAND_CH_SINGLE_0     (0x00)      // Single-ended P = CH0, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_2     (0x10)      // Single-ended P = CH1, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_4     (0x20)      // Single-ended P = CH2, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_6     (0x30)      // Single-ended P = CH3, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_1     (0x40)      // Single-ended P = CH4, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_3     (0x50)      // Single-ended P = CH5, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_5     (0x60)      // Single-ended P = CH6, N = COM
    #define ADS7830_REG_COMMAND_CH_SINGLE_7     (0x70)
